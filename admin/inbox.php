        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">        
					...
					<p><a href="productlist.php">Edit the Stock</a></p>
					...
					<tbody>
						...
						if ($getOrder) {
							while ($result = $getOrder->fetch_assoc()) {
        						...
        						// $availableStock = $ct -> getAvailableStock($productId, $connection); // Replace with your database connection// //
						...
						<tr class="odd gradeX">
							...
							<!-- <td>RM <?php echo $availableStock; ?></td> -->
